...
import aynl.net.biz.dao.docren.AnkleUploadLogDao;
import aynl.net.entity.enums.BucketEnum;
import aynl.net.entity.enums.UploadTypeEnum;
import aynl.net.entity.po.AnkleUploadLog;
import aynl.net.utils.util.MD5;
